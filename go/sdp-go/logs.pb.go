...
const file_logs_proto_rawDesc = "" +
	...
	"\x06FATAL4\x10\x182Y\n" +
	"\vLogsService\x12J\n" +
	"\rGetLogRecords\x12\x1a.logs.GetLogRecordsRequest\x1a\x1b.logs.GetLogRecordsResponse0\x01B1Z/github.com/overmindtech/terraform-provider-overmind/go/sdp-go;sdpb\x06proto3"
