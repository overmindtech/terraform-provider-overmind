...
import (
	...
	"github.com/overmindtech/terraform-provider-overmind/go/sdp-go"
	"github.com/overmindtech/terraform-provider-overmind/go/sdp-go/sdpconnect"
)
...
func GetTestOAuthTokenClient(t *testing.T) *natsTokenClient {
	...
	errorFormat := "environment variable %v not found. Set up your test environment first. See: https://github.com/overmindtech/terraform-provider-overmind/go/auth0-test-data"
